...
def print_symbols_exceeding_highs(new_connection):
    ...
    try:
        ...
        html_content = f"""
            ...
            <body>
                <div class="container">
                <h1>10-Day Breakouts On Coinbase</h1>
                <p><strong>Last updated:</strong> {formatted_datetime}</p>
                <p><strong>Coinbase symbols with 10-day breakout in last 10 days:</strong> {symbols_count}</p>
        """
    ...
    # Adding grouped results to HTML
        ...
        with open("crypto_turtle_breakouts_daily_10.html", "w") as file:
            file.write(html_content)

        print("10 DAY HIGH HTML file with grouped TradingView links created successfully.")
